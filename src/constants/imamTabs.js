...
export const IMAM_TABS = [
  ...
  { id: "wisdomPearls", label: "Wisdom Pearls", icon: "bx-diamond", gradient: "linear-gradient(135deg, #50a5f1 0%, #556ee6 100%)" },
  { id: "medical", label: "Medical", icon: "bx-plus-medical", gradient: "linear-gradient(135deg, #34c38f 0%, #50a5f1 100%)" },
  { id: "community", label: "Community", icon: "bx-group", gradient: "linear-gradient(135deg, #f46a6a 0%, #f1b44c 100%)" },
  { id: "nikahBonus", label: "Nikah Bonus", icon: "bx-heart", gradient: "linear-gradient(135deg, #556ee6 0%, #e83e8c 100%)" },
  { id: "muslimBonus", label: "Muslim Bonus", icon: "bx-star", gradient: "linear-gradient(135deg, #50a5f1 0%, #34c38f 100%)" },
  ...
  { id: "borehole", label: "Borehole", icon: "bx-droplet", gradient: "linear-gradient(135deg, #50a5f1 0%, #34c38f 100%)" },
  { id: "financialAssistance", label: "Financial Assistance", icon: "bx-money", gradient: "linear-gradient(135deg, #f1b44c 0%, #f1734f 100%)" },
