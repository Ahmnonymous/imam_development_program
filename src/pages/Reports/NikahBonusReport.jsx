...
import { GET_NIKAH_BONUS_REPORT } from '../../helpers/url_helper';

const NikahBonusReport = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axiosApi.get(GET_NIKAH_BONUS_REPORT, {
            ...
            console.error('Error fetching nikah bonus:', err);
            setError(err.response?.data?.message || 'Error fetching nikah bonus');
        } finally {
            setLoading(false);
        }
    };
    ...
    const exportToCSV = () => {
        ...
        link.download = `nikah_bonus_report_${new Date().toISOString().split('T')[0]}.csv`;
        link.click();
    };
            ...
            <div className="page-content">
                <div className="container-fluid">
                    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '400px' }}>
                        ...
                        <span>Loading nikah bonus report...</span>
                    </div>
                </div>
            </div>
        );
    ...
    document.title = "Nikah Bonus Report | IDP";

    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Reports" breadcrumbItem="Nikah Bonus Report" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <CardBody>
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    ...
                                                    <Input type="select" value={groupBy} onChange={(e) => setGroupBy(e.target.value)}>
                                                        ...
                                                        <option value="is_first_nikah_name">Is First Nikah</option>
                                ...
                                {!loading && !error && data.length > 0 && (
                                    <Row className="mb-2">
                                        ...
                                        <Col sm={4}>
                                            <Input type="text" className="form-control search-box me-2 mb-2 d-inline-block" placeholder="Search Nikah Bonus..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                                        </Col>
                                    </Row>
                                )}
...
export default NikahBonusReport;
