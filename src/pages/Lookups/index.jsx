  ...
  const lookupGroups = [
    ...
    },
    {
      ...
      categories: [
        ...
        { name: "Water Usage Purpose", table: "Water_Usage_Purpose", icon: "bxs-droplet-half" },
        { name: "Request For", table: "Request_For_Lookup", icon: "bxs-user-check" },
        { name: "Classification", table: "Classification_Lookup", icon: "bxs-tag" },
        { name: "Course Type", table: "Course_Type_Lookup", icon: "bxs-book" },
        { name: "Course Duration", table: "Course_Duration_Lookup", icon: "bxs-time-five" },
        { name: "Study Method", table: "Study_Method_Lookup", icon: "bxs-graduation" },
