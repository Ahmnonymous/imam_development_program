          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            {!isOrgExecutive && (
              <Button 
                color="primary" 
                size="sm" 
                onClick={() => navigate("/imam-profiles/create")} 
                className="btn-sm"
                title="Create New Imam Profile"
              >
              ...
              {imamProfiles.map((imamProfile, index) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => onSelectImamProfile(imamProfile)}
                    style={{ 
                      cursor: "pointer",
...
export default ImamProfileListPanel;
